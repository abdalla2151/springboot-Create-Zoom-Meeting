package com.zoomMeetingVideoChat.component.dto;
...
public class ZoomMeetingOccurenceDTO implements Serializable {
	...
	public String toString() {
		return "ZoomMeetingOccurenceDTO [duration=" + getDuration() + ", occurrence_id=" + getOccurrence_id()
				+ ", start_time=" + getStart_time() + ", status=" + getStatus() + "]";
	}
}
